...
class postfix_expp51(postfix_exp):
    # postfix_exp --> postfix_exp + +
    def __init__(self, postfix_exp, Plus1, Plus2):
        self.postfix_exp = postfix_exp


class postfix_expp52(postfix_exp):
    # postfix_exp --> postfix_exp - -
    def __init__(self, postfix_exp, Minus1, Minus2):
        self.postfix_exp = postfix_exp
...
class unary_expp56(unary_exp):
    # unary_exp --> + + unary_exp
    def __init__(self, Plus1, Plus2, unary_exp):
        self.unary_exp = unary_exp


class unary_expp57(unary_exp):
    # unary_exp --> - - unary_exp
    def __init__(self, Minus1, Minus2, unary_exp):
        self.unary_exp = unary_exp
